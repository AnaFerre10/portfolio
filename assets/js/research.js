/*sobre mim Details Table*/

const sobre mimTable = document.querySelector(".main");
...
const sobre mim = [
  {
    ...
    sobre mimYr: 2020,
    citebox: "popup1",
    image: "assets/images/sobre mim-page/inteferenceNetwork.png",
    citation: {
      vancouver:
...

  {
    ...
    sobre mimYr: 2020,
    citebox: "popup2",
    image: "assets/images/sobre mim-page/crossLingual.png",
    citation: {
      vancouver:
...

  {
    ...
    sobre mimYr: 2020,
    citebox: "popup3",
    image: "assets/images/sobre mim-page/wordRepresentation.png",
    citation: {
      vancouver:
...

  {
    ...
    sobre mimYr: 2020,
    citebox: "popup4",
    image: "assets/images/sobre mim-page/dialogueState.png",
    citation: {
      vancouver:
...

  {
    ...
    sobre mimYr: 2020,
    citebox: "popup5",
    image: "assets/images/sobre mim-page/semanticSegmentation.png",
    citation: {
      vancouver:
...

  {
    ...
    sobre mimYr: 2020,
    citebox: "popup6",
    image: "assets/images/sobre mim-page/deepNetwork.png",
    citation: {
      vancouver:
...

  {
    ...
    sobre mimYr: 2020,
    citebox: "popup7",
    image: "assets/images/sobre mim-page/imageDecomposition.png",
    citation: {
      vancouver:
  ...
  },
  {
    ...
    sobre mimYr: 2020,
    citebox: "popup8",
    image: "assets/images/sobre mim-page/neuralNetworks.jpg",
    citation: {
      vancouver:
...
const fillData = () => {
            ...
            <tr data-aos="zoom-in-left"> 
                ...
                <td class = "sobre mimTitleName">
                    ...
                    <div class="rConferences"> ${conferences} 
                        <div class="sobre mimY">${sobre mimYr}</div>
                    </div>
  ...
  sobre mimTable.innerHTML = output;
};
